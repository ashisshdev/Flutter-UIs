    ...
    return Stack(
      children: [
        Positioned(
            ...
            left: 20,
            child: Opacity(
              opacity: double.parse(convertRange(originalValue: pageValue).toStringAsFixed(2)),
              child: Column(
        ...
        Positioned(
          ...
          top: h * 0.2 - ((1 - convertRange(originalValue: pageValue)) * h * 0.18),
          left: w * 0.32 - ((1 - convertRange(originalValue: pageValue)) * w * 0.28),

          // width: 90,
          child: Container(
            padding: EdgeInsets.all(18 - ((1 - convertRange(originalValue: pageValue)) * 8)),
        ...
        Positioned(
            ...
            top: h * 0.55 - ((1 - convertRange(originalValue: pageValue)) * h * 0.4),
            child: SizedBox(
              height: h * 0.3 + ((1 - convertRange(originalValue: pageValue)) * 70),
              width: w * 0.5,
                    ...
                    children: allSounds
                        .map((e) => Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ImageWidget(sound: e),
                                  SizedBox(width: 8 + ((1 - convertRange(originalValue: pageValue)) * 20)),
                                  Opacity(
                                    opacity: double.parse(convertRange(originalValue: pageValue).toStringAsFixed(2)),
                                    child: Column(
      ...
      child: Stack(
        ...
        children: [
          ...
          sound.name == "Flowing River"
              ? Container(
                  decoration: BoxDecoration(color: Colors.white.withOpacity(0.6), borderRadius: const BorderRadius.all(Radius.circular(40))),
                  child: const Padding(
